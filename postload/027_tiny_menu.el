;;; tiny_menu --- 2018-01-15 01:38:42 μμ
;;; Commentary:
...
;;   "Set current project to workfiles and call projectile-commander."
;;   (interactive)
;;   (projectile--call-workfiles-command 'safe-projectile-ag))
...
(defun projectile-ag-projects ()
  "Set current project to projects and call projectile-commander."
  (interactive)
  (projectile--call-projects-command 'projectile-ag))
