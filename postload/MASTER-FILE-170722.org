...
#+BEGIN_SRC emacs-lisp
  ...
  (defun sclang-add-libs-to-extensions-gui ()
    "Add all 1st level subfolders of sclang user etensions to Library.
  Resolve symbolic links."
    (mapc (lambda (path)
            (message (file-truename path)))
          (file-expand-wildcards "/Users/iani/Library/Application Support/SuperCollider/Extensions/*")
          ;; (file-truename "/Users/iani/Library/Application Support/SuperCollider/Extensions/sc-hacks")
          ))

  (eval-after-load 'sclang
      '(progn
         (define-key sclang-mode-map (kbd "C-h Cy-e") 'sclang-extensions-gui)))
#+END_SRC
