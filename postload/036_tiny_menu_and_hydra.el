;;; tiny_menu_and_hydra --- 2018-10-14 10:40:33 AM
    ;;; Commentary:
               ...
               '(("search/files" ("search/files"
                 ...
                 ("journal/agenda" ("journal/agenda"
                                    ((?a "agenda" org-agenda-list)
                                     (?c "calendar (cfw)" cfw:open-org-calendar)                                                       (?t "todos" org-todo-list)
  ...
  (defhydra hydra-global (global-map "H-g" :color blue :columns 3)
      "global hydra"
...
;;; 036_tiny_menu_and_hydra.el ends here
