(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-journal buffer-move dired+ calfw-cal calfw calfw-org auto-complete electric-pair hs hl-sexp paredit-mode sr-speedbar deft icicles litable paredit mc-extras
