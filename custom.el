(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (w3m ztree perspective-projectile smartparens-config markdown-mode org-journal buffer-move dired+ calfw-cal calfw calfw-org auto-complete electric-pair hs hl-sexp paredit-mode sr-speedbar deft icicles litable paredit mc-extras
