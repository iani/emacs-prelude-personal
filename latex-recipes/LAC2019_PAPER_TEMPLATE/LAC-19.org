...
#+BEGIN_SRC latex
    \def\papertitle{sc-hacks: A Live Coding Framework for Gestural Performance and Electronic Music}
...
%  \captionsetup[figure]{labelfont=it,textfont={bf,it}} % THIS ONE WORKED
%  \captionsetup[figure]{labelfont=it,textfont=it} % ALMOST THERE
